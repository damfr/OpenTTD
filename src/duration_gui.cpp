...
void SetDurationWindow::ShowUnitDropDown()
{
	...
	*list->Append() = new DropDownListStringItem(STR_DURATION_DAYS_UNIT, UDDI_DAYS, false);
	*list->Append() = new DropDownListStringItem(STR_DURATION_MONTHS_UNIT, UDDI_MONTHS, false);
	*list->Append() = new DropDownListStringItem(STR_DURATION_YEARS_UNIT, UDDI_YEARS, false);
