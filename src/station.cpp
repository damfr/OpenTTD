...
/* virtual */ uint Station::GetPlatformLength(ExtendedTileIndex tile) const
{
...
/* virtual */ uint Station::GetPlatformLength(ExtendedTileIndex tile, DiagDirection dir) const
{
