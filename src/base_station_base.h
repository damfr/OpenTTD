...
struct BaseStation : StationPool::PoolItem<&_station_pool> {
	 ...
	 */
	virtual bool TileBelongsToRailStation(ExtendedTileIndex tile) const = 0;
	 ...
	 */
	virtual uint GetPlatformLength(ExtendedTileIndex tile) const = 0;
	 ...
	 */
	virtual uint GetPlatformLength(ExtendedTileIndex tile, DiagDirection dir) const = 0;
...
struct SpecializedStation : public BaseStation {
	 ...
	 * @return the station associated with that tile.
	 */
	static inline T *GetByTile(ExtendedTileIndex tile)
	{
