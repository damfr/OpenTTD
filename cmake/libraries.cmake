...
function(check_load_library PACKAGE_NAME TARGET_NAME  INCLUDE_FILES LIBRARY_NAME VERSION_STRING OPTION_DESC)
	string(TOUPPER ${PACKAGE_NAME} PACKAGE_NAME_UPPER)
	if(WITH_${PACKAGE_NAME_UPPER} OR (WITH_${PACKAGE_NAME_UPPER} STREQUAL "AUTO_DETECT"))
		find_library_static_or_shared(${PACKAGE_NAME} ${TARGET_NAME} ${INCLUDE_FILES} ${LIBRARY_NAME} ${VERSION_STRING})
